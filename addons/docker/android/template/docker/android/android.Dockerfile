...
LABEL Description="This image provides a base Android environment with necessary tools to run tests, generate signed apk, android bundle, and may be used to run tests."
