...
- Updated dependencies [ecce86a]
  - @create-node-app/core@0.9.1

## 0.16.0

### Minor Changes

- c5484ff: feat(cli): add --skip-install as alias for --no-install (#290)
...
- 23a6100: fix(cli): bump @create-node-app/core dependency to ^0.7.5
...
- 92f9b60: Interactive mode UX overhaul: grouped template picker and two-step extension selector.
...
- 89d1cac: Interactive mode overhaul: searchable, single-list template and extension pickers.
